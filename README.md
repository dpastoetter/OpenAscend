...
**Current version: v0.10** (`versionName` **0.10**, `versionCode` **11** in Gradle)
...
Versioning: **v0.10** — `versionName` `0.10`, `versionCode` `11` in `app/build.gradle.kts`. Package id: `com.openascend.app`. **minSdk 26**, **targetSdk / compileSdk 35**.
