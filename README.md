...
**Current version: v0.09** (`versionName` **0.09**, `versionCode` **10** in Gradle)
...
Versioning: **v0.09** — `versionName` `0.09`, `versionCode` `10` in `app/build.gradle.kts`. Package id: `com.openascend.app`. **minSdk 26**, **targetSdk / compileSdk 35**.
